...
export const users = mysqlTable("users", {
    ...
    firebaseUid: varchar("firebaseUid", { length: 255 }).notNull().unique(), // UID from Firebase
    name: varchar("name", { length: 255 }),
    email: varchar("email", { length: 320 }),
    // passwordHash is no longer needed as Firebase handles authentication
    // loginMethod can be deprecated or used to store provider info (e.g., 'google', 'email')
...
export const travelCategoriesRelations = relations(travelCategories, ({ one }) => ({
    travel: one(travels, {
