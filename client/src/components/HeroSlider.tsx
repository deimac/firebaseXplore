                  ...
                  {sidebarItems.map((item, index) => {
                    ...
                    return (
                      <button
                        ...
                        className={`border-2 rounded-lg px-4 py-3 flex items-center justify-center gap-2 hover:opacity-90 transition-all font-medium text-sm ${
                      ...
                      >
                        <Icon className={`w-4 h-4 ${
                          activeSection === item.id ? "stroke-accent-foreground text-accent-foreground" : "stroke-accent text-accent"
                        }`} strokeWidth={1.5} />
